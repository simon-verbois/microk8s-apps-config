...
This folder contains MicroK8s manifests and reusable templates for deploying Seerr.
...
3. Replace placeholders for domain, timezone, storage values, and logging level.
4. Apply the manifests in filename order.
...
- The app stores its persistent data in `/app/config`.
